...
class Wallet(Base):
    ...
    win_rate_p_value: Mapped[Decimal | None] = mapped_column(Numeric)
    ...
    avg_entry_price: Mapped[Decimal | None] = mapped_column(Numeric)
    avg_trade_size: Mapped[Decimal | None] = mapped_column(Numeric)
    avg_hours_before_resolution: Mapped[Decimal | None] = mapped_column(Numeric)
    ...
    funding_exchange: Mapped[str | None] = mapped_column(Text)
    ens_name: Mapped[str | None] = mapped_column(Text)
...
class Trade(Base):
    ...
    hours_before_resolution: Mapped[Decimal | None] = mapped_column(Numeric)
    resolution_outcome: Mapped[str | None] = mapped_column(Text)
    trade_won: Mapped[bool | None] = mapped_column(Boolean)
...
class FundingChain(Base):
    ...
    source_exchange: Mapped[str | None] = mapped_column(Text)
...
class Cluster(Base):
    ...
    cluster_type: Mapped[str | None] = mapped_column(Text)
    evidence: Mapped[str | None] = mapped_column(Text)
    total_pnl: Mapped[Decimal | None] = mapped_column(Numeric)
    combined_win_rate: Mapped[Decimal | None] = mapped_column(Numeric)
    markets_in_common: Mapped[list[str] | None] = mapped_column(ARRAY(Text))
    insider_probability: Mapped[Decimal | None] = mapped_column(Numeric)
...
class Market(Base):
    ...
    volume_total: Mapped[Decimal | None] = mapped_column(Numeric)
